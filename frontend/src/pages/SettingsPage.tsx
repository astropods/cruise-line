...
function LockedScreen() {
  // Non-owner user hit /settings directly. Everything they can do (manage
  // their CLI tokens, install the CLI) lives on the home page now — send
  // them there instead of showing a dead-end "not authorized" screen.
